...
async function logSecurityEvent(securityContext = {}, req = {}) {
  try {
    ...
    const eventData = {
      ...
      telemetry: {
        clientIp: ip,
        entityId: telemetry.entityId || ip,
        entityType: telemetry.entityType || 'IP',
        requestFrequency: telemetry.requestFrequency || 1,
        burstFrequency: telemetry.burstFrequency || 1,
        failedAuthAttempts: telemetry.failedAuthAttempts || 0,
        error4xxRate: telemetry.error4xxRate || 0.0,
        pathEntropy: telemetry.pathEntropy || 1.0,
        avgIntervalMs: telemetry.avgIntervalMs || 5000.0,
